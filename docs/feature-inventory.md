...
| Campo | Valor |
|-------|--------|
| **Última actualización** | 2026-08-31 (LP plan Dedicado + pricing source) |
...
| Precios informativos | hecho | USD 29/79/99 desde Clerk/legal; plan Dedicado (auditoría IoT/ERP) a cotizar |
